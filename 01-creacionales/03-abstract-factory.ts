...
const restaurantAbstractFactory = (factory: RestaurantFactory) => {
...
restaurantAbstractFactory(new FastFoodRestaurantFactory());
restaurantAbstractFactory(new HealthyRestaurantFactory());
